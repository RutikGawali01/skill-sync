  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-950 via-violet-950 to-indigo-950 px-4 py-12 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute -top-32 right-0 w-96 h-96 bg-violet-600 rounded-full opacity-20 blur-3xl" />
        <div className="absolute bottom-0 -left-24 w-80 h-80 bg-indigo-600 rounded-full opacity-15 blur-3xl" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-fuchsia-700 rounded-full opacity-10 blur-3xl" />
      </div>
        ...
        <div className="bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl rounded-3xl shadow-2xl shadow-black/20 border border-white/50 dark:border-gray-700/50 p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
              Join 12,000+ learners exchanging skills today
            </p>
          </div>
